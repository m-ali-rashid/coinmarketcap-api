...
const Home = (props) => {
  ...
  const classes = useStyles();
   return (
    <div>
        <div className="row">
            <div className="col-md-8 m-0 p-0 border" style={{maxHeight:'400px',overflow:'hidden'}}>

                <div className={classes.parentDiv}>
                  <div className={classes.childImage}>
                    <p className=""><span className="badge text-left text-white" style={{background:'#8064a4',fontSize:'1rem', padding:'0.5rem'}}>#NEWS</span></p>
